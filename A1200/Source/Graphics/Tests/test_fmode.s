...
*"""""""""""""""""""""
	...
	move.w	#40,d2			width of one bitplanes
	lea	y.table(pc),a0
...
fill.loop
	...
	lea	8000(a2),a3		bitplane 2
	lea	16000(a2),a4		bitplane 3
	lea	24000(a2),a5		bitplane 4
...
init.copper
	moveq	#8-1,d1
	move.l	#8000,d2		size of one bitplane

.next1	move.w	d0,6(a0)		save low word
	swap	d0
...
colours	ds.w	LINES*41*2		1 WAIT, 40 MOVES
