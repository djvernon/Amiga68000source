...
; TO DO:
; 4. Double buffer fill sources, to allow blit_wait to be later in render_frame
...
initialise
	...
	bsr	make_dots_table			; must be before conver_graphic_data
...
;	bsr	scale_vertically	; create copper list to set bitplane ptrs on required raster lines
	...
	bsr	blit_wait		; wait for blitter to finish clearing fill source
; TO DO - double buffer fill sources, to allow blit_wait to be later?
	lea	plane1to4_data,a1
	lea	plane1to4_fill_source,a2
	bsr	plot_fill_dots
; e.g. move blit_wait to here?
	bsr	fill_plane1
...
; e.g.
; -50,dots3,0,40,80		x pos -50, plot 3 dots, bitplane offset 0,40 and 80 (i.e. lines 0,1 and 2)
; -49,dots4,40,80,120,160	x pos -49, plot 4 dots, bitplane offset 40,80,120 and 160 (i.e. lines 1,2,3 and 4)
; $4000				end marker
;
...
DOTS_INSTRUCTIONS_SIZE	equ	6	; 6 bytes for each pair of move and eor instructions
...
dots300	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots299	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots298	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots297	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots296	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots295	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots294	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots293	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots292	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots291	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots290	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots289	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots288	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots287	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots286	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots285	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots284	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots283	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots282	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots281	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots280	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots279	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots278	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots277	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots276	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots275	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots274	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots273	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots272	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots271	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots270	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots269	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots268	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots267	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots266	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots265	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots264	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots263	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots262	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots261	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots260	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots259	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots258	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots257	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots256	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots255	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots254	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots253	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots252	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots251	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots250	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots249	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots248	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots247	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots246	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots245	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots244	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots243	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots242	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots241	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots240	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots239	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots238	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots237	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots236	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots235	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots234	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots233	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots232	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots231	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots230	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots229	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots228	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots227	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots226	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots225	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots224	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots223	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots222	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots221	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots220	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots219	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots218	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots217	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots216	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots215	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots214	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots213	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots212	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots211	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots210	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots209	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots208	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots207	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots206	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots205	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots204	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots203	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots202	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots201	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots200	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots199	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots198	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots197	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots196	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots195	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots194	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots193	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots192	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots191	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots190	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots189	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots188	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots187	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots186	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots185	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots184	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots183	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots182	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots181	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots180	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots179	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots178	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots177	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots176	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots175	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots174	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots173	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots172	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots171	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots170	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots169	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots168	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots167	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots166	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots165	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots164	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots163	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots162	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots161	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots160	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots159	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots158	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots157	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots156	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots155	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots154	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots153	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots152	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots151	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots150	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots149	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots148	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots147	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots146	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots145	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots144	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots143	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots142	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots141	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots140	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots139	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots138	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots137	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots136	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots135	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots134	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots133	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots132	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots131	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots130	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots129	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots128	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots127	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots126	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots125	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots124	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots123	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots122	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots121	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots120	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots119	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots118	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots117	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots116	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots115	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots114	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots113	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots112	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots111	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots110	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots109	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots108	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots107	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots106	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots105	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots104	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots103	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots102	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots101	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots100	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots99	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots98	move.w	(a1)+,d3
...
dots2	move.w	(a1)+,d3
	eor.b	d6,(a3,d3.w)
dots1	move.w	(a1)+,d3		; get next bitplane offset (i.e. offset to required line)
	eor.b	d6,(a3,d3.w)		; plot pixel
dots0	bra	next_x


fill_plane1
	lea	plane1to4_fill_source+(SOURCE_HEIGHT*BYTES_PER_LINE)-2,a0
	move.l	screen1,a1
...
fill_plane2
	lea	plane1to4_fill_source+(2*SOURCE_HEIGHT*BYTES_PER_LINE)-2,a0
	move.l	screen1,a1
...
fill_plane3
	lea	plane1to4_fill_source+(3*SOURCE_HEIGHT*BYTES_PER_LINE)-2,a0
	move.l	screen1,a1
...
fill_plane4
	lea	plane1to4_fill_source+(4*SOURCE_HEIGHT*BYTES_PER_LINE)-2,a0
	move.l	screen1,a1
