...
* Skip past AmigaDOS header

	move.l	File2Handle(pc),d1
	moveq	#32,d2			skip 32 bytes
...
title	dc.b	'Differences V1.0  --  Written by Daniel Vernon in 1993',10,10
	dc.b	'This version skips past AmigaDOS header of file2',10
	dc.b	'(file1 = image, file2 = org''d executable, no reloc info)',10,10
titlelen	equ	*-title
