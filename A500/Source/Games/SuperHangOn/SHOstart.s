...
* Transfers Chip / Slow RAM images contained within this program from Fast
* RAM into Chip (0-$7ffff) / Slow RAM ($c00000-$c7ffff) respectively.  This
* program MUST therefore be loaded into Fast RAM so WinUAE must be
* configured with 512Kb Chip, 512Kb Slow and atleast 2Mb Fast RAM.
* (The program will be forced into the Fast RAM because it's greater than
* 1Mb in size, due to the two RAM images.)
