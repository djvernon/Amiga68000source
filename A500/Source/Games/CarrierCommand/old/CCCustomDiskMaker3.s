...
color0	equ	$180
	...
	lea	copper2(pc),a0
	move.l	#screenData+120,d0	start of screen, bitplane 4
	moveq	#4-1,d7
setCopper
	move.w	d0,6(a0)
	swap	d0
...
setup.screen
	lea	screenDataEnd,a0	end of screen area
	moveq	#0,d0
	moveq	#0,d1
	moveq	#0,d2
	moveq	#0,d3
...
.loop	movem.l	d0-d3,-(a0)		clear the screen
	...
	lea	screenData+120,a0	start of screen, bitplane 4
...
print.char
	lea	screenData,a5		start of screen, bitplane 1
	move.w	d2,d3			y
	lsl.w	#5,d3			y*32
	move.w	d3,d5
	add.w	d3,d3			y*64
