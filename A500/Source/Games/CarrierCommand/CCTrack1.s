...
* Carrier Command boot and backup code, destined for track 1 *
* NB The Carrier Command boot routine loads this code to address $400 onwards

;	Steps to create CCTrack1 binary:-
;	1) Assemble this source file to disk
;	2) Use HxD to remove the first 32 bytes and last 4 bytes (AmigaDOS executable headers / end)


;	Copied from CCbackup.s on 16/05/2019, then the 'start' code at the top was removed
...
next.colour
	...
	move.w	#1,(top.head).w		use top head
