...
TEST_MULTIPLES	equ	100	* number of times to run original tests, set to 1 for original
...
l2656FC	movea.l	4,a6
	...
	move.l	d0,l2661C8
	bsr	print.text
	dc.b	FF,'SPEED 2.01 - Amiga Performance Analyser by Daniel Vernon, July 2004.',LF
	dc.b	'(Based on SPEED 2.00 - by Jez San (c)1989 Argonaut Software).',LF,LF
	...
	bsr	print.text
	dc.b	'68040',0
	move.l	#TEST_MULTIPLES*$258,l2661D0
	bra.s	l265A2C
...
l2659C4	btst	#2,d0
	...
	bsr	print.text
	dc.b	'68030',0
	move.l	#TEST_MULTIPLES*$2E4,l2661D0
	bra.s	l265A2C
...
l2659E0	btst	#1,d0
	...
	bsr	print.text
	dc.b	'68020',0
	move.l	#TEST_MULTIPLES*$2FA,l2661D0
	bra.s	l265A2C
...
l2659FC	btst	#0,d0
	...
	bsr	print.text
	dc.b	'68010',0
	move.l	#TEST_MULTIPLES*$69E,l2661D0
	bra.s	l265A2C

l265A18	bsr	print.text
	dc.b	'68000',0

	move.l	#TEST_MULTIPLES*$6C4,l2661D0
l265A2C	bsr	print.text
	...
	move.l	l2661D0,d0
	move.l	d0,d5
	bsr	print.decimal.with.hundredths
	bsr	print.text
...
* l265D7C
analyze.clockspeed
	move.w	#TEST_MULTIPLES,d6
acloop	move.w	#$C350,d7
	move.l	#$FFFF,d2
	move.l	#$FFFF,d3
