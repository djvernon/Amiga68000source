...
clear.colours
	...
	lea	end.crunched.screen(pc),a0
	move.l	screen.mem(pc),a1
	lea	crunched.screen+4(pc),a2
	lea	$dff180,a3
	bsr	ppDecrunch
	...
	move.l	#colour.table,fade.colours
...
; a0 = pointer to longword right after crunched file
; a1 = pointer to destination buffer
; a2 = pointer to efficiency table
; a3 = colour register address, etc.
; destroys a0-a1/a4 and d0-d3/d5-d7

ppDecrunch
	moveq	#3,d6
	moveq	#7,d7
	moveq	#1,d5
	move.l	a1,a4			; remember start of file
...
CrunchedBytes
	...
	moveq	#0,d0
	move.b	(a2,d1.w),d0		; get number of bits of offset
