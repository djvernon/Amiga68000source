...
draw.horizon
	...
	move.w	x.angle(pc),d1		y1
	asr.w	#1,d1
	move.w	d1,d3			y2

	move.w	z.angle(pc),d4
	lea	cosine(pc),a1
	move.w	(a1,d4.w),d5		cosz
	lea	sine(pc),a1
	move.w	(a1,d4.w),d4		sinz
	...
	muls	d0,d5			x1 cosz
	muls	d1,d4			y1 sinz
	add.l	d5,d4			x1 cosz + y1 sinz
	add.l	d4,d4
	swap	d4
	add.w	#XMID,d4		rotated x1
	move.w	d4,x1
	...
	muls	d0,d6			x1 sinz
	muls	d1,d7			y1 cosz
	sub.l	d6,d7			y1 cosz - x1 sinz
	add.l	d7,d7
	swap	d7
	add.w	#YMID,d7		rotated y1
	move.w	d7,y1
	...
	muls	d2,d5			x2 cosz
	muls	d3,d4			y2 sinz
	add.l	d5,d4			x2 cosz + y2 sinz
	add.l	d4,d4
	swap	d4
	add.w	#XMID,d4		rotated x2

	muls	d2,d6			x2 sinz
	muls	d3,d7			y2 cosz
	sub.l	d6,d7			y2 cosz - x2 sinz
	add.l	d7,d7
	swap	d7
	add.w	#YMID,d7		rotated y2
...
calc.sin.cos.values
	...
	lea	cosine(pc),a1
	move.w	(a1,d0.w),d1		cosz
	lea	sine(pc),a1
	move.w	(a1,d0.w),d0		sinz
