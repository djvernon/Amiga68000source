...
loop	move.w	tank1.y.angle(pc),base.y.angle
	...
	move.w	tank2.y.angle(pc),base.y.angle
	movem.w	base.x.angle(pc),d0-d2
	lea	sin.cos.values(pc),a0
	bsr	calc.sin.cos.values
	move.w	#$1c0,x.offset
	lea	tank(pc),a0
	...
	addq.w	#3*2,tank1.y.angle
	and.w	#$7fe,tank1.y.angle

	subq.w	#3*2,tank2.y.angle
	and.w	#$7fe,tank2.y.angle
...
fill.table
	dc.l	mask4,mask3,mask2,mask8,mask5,mask1,mask6,mask7



fill.it	move.w	#3*64,d2		height = 3
...
fill.it.loop
	...
	or.w	d2,d1			bltsize value, with height = 3
...
;					set pointer for correct colour
	move.w	(a4)+,d0		first x-start
	bpl.s	stipple.fill.it
	rts



stipple.fill.table
	dc.l	mask11,mask10,mask16,mask13,mask9,mask14,mask15



stipple.fill.it
	move.w	#3*64,d2		height = 3
	moveq	#16,d5
...
mask9	dcb.w	20,$5555
mask10	dcb.w	20,0
mask11	dcb.w	20,$5555
mask13	dcb.w	20,0
mask14	dcb.w	20,0
mask15	dcb.w	20,$5555
mask16	dcb.w	20,$5555
	dcb.w	20,$5555
	dcb.w	20,0
...
tank1.y.angle	dc.w	0
tank2.y.angle	dc.w	0
...
x.offset	dc.l	0
y.offset	dc.l	$1400000
z.offset	dc.l	$5000000
...
colour.table
	dc.w	$000,$853,$a63,$c73,$e93,$567,$789,$9ab
	dc.w	$000,$683,$7a3,$8c3,$9e3,$567,$789,$9ab
...
tank	dc.w	rotate.coords.offset
	dc.w	0
	dc.w	40-1
...
; body
	...
	dc.w	2+4*2
	dc.w	4
	dc.w	P21,P17,P18,P22

	dc.w	polygon.orientation.offset
	dc.w	P24,P23,P19
	dc.w	2+4*2
	dc.w	4
	dc.w	P24,P23,P19,P20
...
; gun
	...
	dc.w	2+4*2
	dc.w	4
	dc.w	P40,P39,P35,P36

	dc.w	polygon.orientation.offset
	dc.w	P37,P33,P34
	dc.w	2+4*2
	dc.w	4
	dc.w	P37,P33,P34,P38
	...
	dc.w	2+4*2
	dc.w	4
	dc.w	P37,P40,P36,P33

	dc.w	polygon.orientation.offset
	dc.w	P38,P34,P35
	dc.w	2+4*2
	dc.w	4
	dc.w	P38,P34,P35,P39
...
; rest of turret
	...
	dc.w	2+4*2
	dc.w	4
	dc.w	P29,P25,P26,P30

	dc.w	polygon.orientation.offset
	dc.w	P32,P31,P27
	dc.w	2+4*2
	dc.w	4
	dc.w	P32,P31,P27,P28
