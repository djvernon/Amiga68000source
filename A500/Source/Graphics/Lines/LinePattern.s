...
vp.wait	move.l	vposr(a6),d0		get vertical beam position
	...
	move.w	#$000,color0(a6)	initialise colours
	move.w	#$0c8,color1(a6)
...
no.sign	add.w	d2,d2			2 Ldelta
	...
	moveq	#-1,d5
	moveq	#40,d6			width of one bitplane
...
bltfin	btst	#6,dmaconr(a6)
	...
	move.w	a2,bltbdat(a6)		set line mask
