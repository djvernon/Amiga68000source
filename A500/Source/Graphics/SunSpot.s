...
vp.wait	move.l	vposr(a6),d0		get vertical beam position
	...
	lea	screen.data(pc),a0	initialise colours
	lea	4*40*200(a0),a0
	lea	color0(a6),a1
	moveq	#8-1,d0
...
the.bollocks.of.bryan
	move.l	#$9f00000,bltcon0(a6)
	moveq	#-1,d7
	move.l	d7,bltafwm(a6)
	move.w	#40*199,bltamod(a6)
	move.w	#0,bltdmod(a6)
	move.w	#4*64+20,d7

	move.w	#200,d6
	lea	screen.data(pc),a4
	lea	40*200(a4),a4
	move.l	screen.mem(pc),a5
...
screen.data	incbin	Crunched/End_of_Turrican.bin
